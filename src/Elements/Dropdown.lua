...
function Element:New(Idx, Config)
	...
	function Dropdown:GetActiveValues()
		...
		function Dropdown:BuildDropdownList()
            ...
            local currentDropdownValue = Dropdown.Value
            ...
            for Idx, Value in ipairs(Values) do
                ...
                local Selected = isMulti and currentDropdownValue[Value] or currentDropdownValue == Value
                ...
                function Table:UpdateButton()
                    local isSelected = isMulti and currentDropdownValue[Value] or currentDropdownValue == Value
                ...
                -- Update ListSizeX based on ButtonLabel width
            ...
            -- Update Dropdown list size after loop
